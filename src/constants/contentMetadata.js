export const tvContent = [
    ...
    {
        title:          'Super Size Me',
        description:    "Director Morgan Spurlock's social experiment in fast-food gastronomy sees him attempting to subsist exclusively on food from McDonald's.",
        genre:          'documentary',
        maturityRating: 12,
        slug:           'super-size-me',
    },
    ...
    },
    {
        ...
        description:    'The Bluth family, once a prominent name in the business, loses everything after the head patriarch is convicted of fraud.',
        genre:          'comedy',
        maturityRating: 15,
...
export const movieContent = [
    ...
    {
        title:          'La La Land',
        description:    'Sebastian (Ryan Gosling) and Mia (Emma Stone) are drawn together by their common desire to do what they love. But as success mounts, they are faced with decisions that test their loyalty to their profession -- and each other.',
        genre:          'romance',
        maturityRating: 15,
        slug:           'la-la-land',
    },
